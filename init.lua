...
require("lazy").setup({
  spec = {
    ...
    { import = "plugins.language.markdown.render-markdown" },
    { import = "plugins.language.markdown.mkdnflow" },
    { import = "plugins.language.markdown.tabular" },
    { import = "plugins.language.markdown.mdmath" },
